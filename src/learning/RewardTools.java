...
public class RewardTools {
	...
	public static double getReward(GameState initial_state,Agent_B bomberman_agent,ArrayList<Agent_Ennemy> ennemy_agents,Reward reward,int size_max_trajectory)
	{
